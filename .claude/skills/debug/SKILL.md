...
|-----|----------|---------|
| **Main app logs** | `logs/nanoclaw.log` | Host-side Signal/WhatsApp, routing, container spawning |
...
echo -e "\n3. Docker running?"
docker info &>/dev/null && echo "OK" || echo "NOT RUNNING - start Docker Desktop"
