...
> - Triggered only from WhatsApp (e.g., "@Kevin check my email" or "@Kevin send an email to...")
...
>
> `@Kevin check my recent emails`
>
> Or:
>
> `@Kevin list my Gmail labels`
...
> - Emails with a subject starting with a keyword (e.g., "[Kevin]")
...
Complete all Tool Mode steps above before continuing. Verify Gmail tools work by having the user test `@Kevin check my recent emails`.
